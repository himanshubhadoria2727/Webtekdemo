...
const config: SingleServicePageConfig = {
  ...
  intro: { eyebrow: "Built for business growth", title: "Websites that work as hard as your marketing", items: ["A strong website is more than a digital brochure. It should build trust quickly, help people find the right information and guide them toward a clear next step.", <>Our designers, developers, content specialists and <Link href="/our-services#services-overview">digital marketing team</Link> work together, connecting user experience, technology, SEO and conversion from the beginning.</>, "From focused landing pages to corporate websites, ecommerce stores and web applications, every build is shaped around your goals, internal workflows and plans for growth."] },
  ...
  reasons: { eyebrow: "One team from brief to growth", title: "Why choose Webtek Digital for website development in Dubai?", items: reasons, footer: <>Need traffic after launch? Our <Link href="/our-services#services-overview">SEO</Link>, <Link href="/our-services#services-overview">Google Ads</Link>, content and social teams can turn the new website into a connected growth platform.</> },
