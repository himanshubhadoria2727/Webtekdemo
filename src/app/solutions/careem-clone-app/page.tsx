...
const config: CloneAppTemplateConfig = {
  ...
  modules: [
    { number: "01", label: "Passenger app", title: "Simple booking from pickup to payment.", text: "Passengers can register securely, search by map, save places, compare ride categories, view fare and arrival estimates, schedule rides, track captains, pay by card, wallet or cash, share trips and manage receipts, ratings and support.", image: "/solutions/talabat/An intuitive experience that drives repeat orders..png", alt: "Passenger ride booking application interface" },
    { number: "02", label: "Captain app", title: "Clear ride tasks, navigation and earnings visibility.", text: "Approved captains can manage availability, receive and accept ride requests, navigate to pickup, update trip status, share location, review payment status and monitor earnings, incentives, documents and performance.", image: "/solutions/talabat/Keep delivery partners moving efficiently..png", alt: "Captain ride request and navigation application interface" },
    { number: "03", label: "Fleet management portal", title: "Operational control for vehicles and driver groups.", text: "Fleet managers can onboard captains and vehicles, maintain permits and insurance records, assign drivers, monitor availability, review utilisation and earnings, and manage compliance, maintenance and settlements.", image: "/solutions/talabat/Independent controls for every restaurant..png", alt: "Fleet management portal for ride-hailing operations" },
    { number: "04", label: "Admin dashboard", title: "Central oversight across the entire platform.", text: "Authorised teams can manage passengers, captains, fleets, vehicles, active rides, dispatch, geofences, fares, payments, support, safety cases, campaigns, permissions, reports and audit history.", image: "/solutions/talabat/Manage the entire marketplace in one place..png", alt: "Ride-hailing administration and dispatch dashboard" },
  ],
  ...
  technologyImage: "/solutions/talabat/%20teck-stacks%20.png",
