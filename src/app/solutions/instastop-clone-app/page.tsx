...
const config: CloneAppTemplateConfig = {
  ...
  heroImage: "/solutions/instashop/instashop.png",
  heroImageAlt: "InstaShop grocery delivery arriving at a customer's home",
  overview: [
  ...
  modules: [
    { number: "01", label: "Customer app", title: "Groceries in a few clear steps.", text: "Give customers a convenient way to find local stores, browse products, manage their basket, select delivery and track every order. The experience can be developed for iOS, Android and responsive web ordering.", image: "/solutions/instashop/customer-using-instashop-app.png", alt: "Customer browsing groceries in an InstaShop-style mobile app" },
    { number: "02", label: "Merchant portal", title: "Practical controls for store teams.", text: "Provide supermarket and retail teams with secure tools to manage products, availability, pricing, incoming orders, substitutions, promotions and store-level reporting.", image: "/solutions/instashop/instashop-grocery-app-ui-ux-with-logo.png.png", alt: "InstaShop-style grocery catalogue and basket interfaces" },
    { number: "03", label: "Delivery partner app", title: "Clear delivery tasks from collection to handover.", text: "Equip delivery partners with delivery requests, collection details, customer addresses, navigation, live status updates, proof of delivery and earnings history.", image: "/solutions/instashop/instashop-delivery-rider-original-logo.png", alt: "InstaShop delivery partner carrying a grocery order" },
    { number: "04", label: "Admin dashboard", title: "Central oversight across the platform.", text: "Manage customers, merchants, stores, orders, payments, delivery activity, refunds, promotions, support and business reporting through one secure dashboard.", image: "/solutions/instashop/instashop-backend-dashboard.png", alt: "InstaShop-style grocery marketplace administration dashboard" },
  ],
  ...
  technologyImage: "/solutions/instashop/instashop-marketplace-tech-stack.png",
